<?php 
    ...
    $tituloActividad = $_GET['tituloActividad'];
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="Entregas-Estudiante.php">Actividades</a>
                    </div>
                </div>
            </li>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800"><?php echo "Subir entrega - ".$tipoActividad.": ".$tituloActividad?></h1>
                    </div>
                    ...
                    <div class="row">
                        <!-- Grow In Utility -->
                        <div class="col-lg-15">
                            <form action="../../Controlador/EntregarActividad.php?
                            codigoEstudiante=<?php echo $codigoEstudiante?>
                            &idActividad=<?php echo $idActividad?>
                            " method="POST" enctype="multipart/form-data" id="formularioActividad">
                                <div class="card position-relative">
                                    <div class="card-header py-10">
                                        <h6 class="m-0 font-weight-bold text-primary">Subir-Actividad</h6>
                                        <p class="mb-0 small">Suba el documento con la solución a la actividad.</p>
                                    </div>
                                    <div class="small mb-1">Documento de solución:</div>
                                    <nav class="navbar navbar-expand navbar-light bg-light mb-4">
                                        <input  type="file" name="solucion" id="form3Example4" class="form-control form-control-lg" />
                                    </nav>
