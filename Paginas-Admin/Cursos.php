                        ...
                        <li class="nav-item">
                            ...
                            aria-expanded="true" aria-controls="collapseTwo">
                                ...
                                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                                    <div class="bg-white py-2 collapse-inner rounded">
                                    <a class="collapse-item" href="#">Lista-Cursos</a>
...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div>
        <h1>
          <i class="app-menu fas fa-chalkboard-teacher"></i>Lista de Cursos
...
?>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Registrar-Cursos</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                
                    <form action="../Controlador/Registrar-Curso.php" method="POST" id="formulario" enctype="multipart/form-data">
                        <div class="modal-content">
                        <div class="modal-body">
                            <label form="nombre"> Ingrese codigo del curso</label>
                            <input type="text" name="codigo" id="codigo" class="form-control">
                            <br/>
                            <label form="nombre"> Ingrese el nombre del curso</label>
                            <input type="text" name="nombre" id="nombre" class="form-control">
                            <br/>
                            <label form="nombre"> Ingrese una descripcion</label>
                            <textarea name="descripcion" id="descripcion" rows="numero_de_filas" cols="numero_de_columnas"></textarea>
                            <br/>
                            <label form="nombre"> Ingrese el valor del curso</label>
                            <input type="number" name="precio" id="precio" rows="numero_de_filas" cols="numero_de_columnas"></textarea>
                            <br/>
                        </div>
                        <div class="modal-footer">
                        <input type="hidden" name="id_docente" id="id_docente">
                        <input type="hidden" name="operacion" id="operacion">
                        <Button name="registrar-curso" type="submit" class="btn btn-primary btn-lg"
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <a class="text-xs font-weight-bold text-primary text-uppercase mb-1"
                                        href="Modulos.php?idcurso=<?php echo $mostrar['codigo'] ?>"> 
